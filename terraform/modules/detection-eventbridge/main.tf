...
# IMPORTANT: CloudWatch Logs targets do NOT support role_arn in PutTargets.
# Access is granted via CloudWatch Logs resource policy (aws_cloudwatch_log_resource_policy).
